...
// getPostSpecialties = function(post){
//   var postSpecialties = _.map(post.specialties, function(specialtyId){
//     return Specialties.findOne(specialtyId);
//   });
//   // put resulting array through a filter to remove empty values in case
//   // some of the post's specialties weren't found in the database
//   return _.filter(postSpecialties, function(e){return e});
// }
