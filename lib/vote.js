(function() {
  ...
  var upvote = function(collection, id, user) {
    ...
    // Karma     
    // user's phrases and comments do not impact his own karma:
  ...
  Meteor.methods({
    upvotePhrase: function(phraseId, user){
      var user = getUser(user);
      return upvote.call(this, Phrases, phraseId, user);
    },
    downvotePhrase: function(phraseId, user){
      var user = getUser(user);
      return downvote.call(this, Phrases, phraseId, user);
    },
    cancelUpvotePhrase: function(phraseId, user){
      var user = getUser(user);
      return cancelUpvote.call(this, Phrases, phraseId, user);
    },
    cancelDownvotePhrase: function(phraseId, user){
      var user = getUser(user);
      return cancelDownvote.call(this, Phrases, phraseId, user);
    },
