...
- Invite-only access for reading and/or phraseing
- Markdown support
- Day by day view
...
- Set the mail URL variable used for email notifications (for example, with [Mailgun](http://mailgun.com) on Heroku: `heroku config:add MAIL_URL=smtp://phrasemaster%40YOUR_DOMAIN.mailgun.org:YOUR_PASSWORD@smtp.mailgun.org:587/`)
